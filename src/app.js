...
function snapshot() {
  return {
    ...
    source: "sorting-hat-three-control-mark",
  ...
  app.innerHTML = `
    <header class="topbar">
      <div class="brand">
        ...
        <div>
          <div class="brand-kicker">Sorting Hat</div>
          <h1 class="brand-title">Pull a routing mark into shape.</h1>
        </div>
      </div>
...
function buildMarkdown(snap) {
  return `---
record_id: ${snap.person}-${today}-sorting-hat
...
# ${snap.person} sorting hat routing mark
